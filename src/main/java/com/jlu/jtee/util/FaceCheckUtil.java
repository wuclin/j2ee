...
/*
    ...
    private static Mat conv_Mat(String img_1) throws IOException {
        byte[] bytes = FileUtils.readFileToByteArray(new File(img_1));

        Mat image0 = Imgcodecs.imdecode(new MatOfByte(bytes), Imgcodecs.IMREAD_UNCHANGED);
